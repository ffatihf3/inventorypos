            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=kategori&uid=<?php echo $isi['id_kategori']; ?>"><button class="btn btn-info btn-md mr-2 rounded-circle"><i class="fa fa-edit"></i></button></a>
                            <a href="fungsi/hapus/hapus.php?kategori=hapus&id=<?php echo $isi['id_kategori']; ?>" onclick="javascript:return confirm('Hapus Data Kategori ?');"><button type="button" class="btn btn-danger btn-md mr-2 rounded-circle"><i class="fa fa-trash-alt"></i></button></a>
                        </td>
                    </tr>
                <?php $no++;
                } ?>
