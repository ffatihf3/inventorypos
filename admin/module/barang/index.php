        ...
        if ($r > 0) {
            echo "
				<div class='alert alert-info'>
					<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:red'>$r</span> barang yang Stok tersisa sudah kurang dari 3 items. silahkan input lagi !!
					<span class='pull-right'><a href='index.php?page=barang&stok=yes'  style='text-decoration: none; color: #36b9cc;'>Cek Barang <i class='fa fa-angle-double-right'></i></a></span>
				</div>
				";
        }
        ?>
        ...
        <a href="index.php?page=barang" class="btn btn-success btn-md">
            <i class="fa fa-retweet"></i> Refresh Data</a>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="index.php?page=barang/details&barang=<?php echo $isi['id_barang']; ?>"><button class="btn btn-info btn-md mr-2 rounded-circle"><i class="fa fa-eye"></i></button></a>
                                        <a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang']; ?>"><button class="btn btn-info btn-md mr-2 rounded-circle"><i class="fa fa-edit"></i></button></a>
                                        <a href=" fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang']; ?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button type="button" class="btn btn-danger btn-md mr-2 rounded-circle"><i class="fa fa-trash-alt"></i></button></a>
                                    <?php } ?>
                            </tr>
                        <?php
                            $no++;
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content" style=" border-radius:0px;">
                    <div class="modal-header" style="background:#36b9cc;color:#fff;">
