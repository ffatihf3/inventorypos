 <?php
	...
	?>
 <h4 style="font-weight: bold;">Keranjang Penjualan</h4>
 <br>
 ...
 <div class="row">
 	<div class="col-sm-4">
 		<div class="card card-info mb-3">
 			<div class="card-header bg-info text-white">
 				<h5 style="font-weight: bold;"><i class="fa fa-search"></i> Cari Barang</h5>
 			</div>
 			<div class="card-body">
 	...
 	<div class="col-sm-8">
 		<div class="card card-info mb-3">
 			<div class="card-header bg-info text-white">
 				<h5 style="font-weight: bold;"><i class="fa fa-table"></i> Hasil Pencarian</h5>
 			</div>
 			<div class="card-body">
 	...
 	<div class="col-sm-12">
 		<div class="card card-info">
 			<div class="card-header bg-info text-white">
 				<h5 style="font-weight: bold;"><i class="fa fa-cash-register"></i> KASIR
 					<a class="btn btn-danger float-right" onclick="javascript:return confirm('Apakah anda ingin reset keranjang ?');" href="fungsi/hapus/hapus.php?penjualan=jual">
 						<i class="fa fa-recycle"></i> <b>RESET KERANJANG</b></a>
 				</h5>
 			</div>
 			<div class="card-body">
 						...
 						<tbody>
 							...
 							<?php foreach ($hasil_penjualan  as $isi) { ?>
 								<tr>
 									...
 									<td>
 										<button type="submit" class="btn btn-warning"><i class="fa fa-retweet"></i></button>
 										</form>
 										<!-- aksi ke table penjualan -->
 						...
 						<table class="table table-stripped">
 							...
 							<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
 								...
 								<tr>
 									...
 									<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i></button>
